...
public class CustomerTest extends Customer {
	...
	public void ytdFeesTest() {
		...
		// Created
		Customer fee = new Customer(bankName, customerName, customerID);

		// Debugged
		System.out.println(fee.ytdFees());

		// Tested
		Assert.assertTrue(fee.ytdFees() == 0.0);
	...
	public void ytdInterestTest() {
		...
		// Created
		Customer interest = new Customer(bankName, customerName, customerID);

		// Debugged
		System.out.println(interest.ytdInterest());

		// Tested
		Assert.assertTrue(interest.ytdInterest() == 0.0);
	}
