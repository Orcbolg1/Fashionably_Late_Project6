...
public abstract class Account implements Comparable<Account> {
	...
	/**
	 * If the account doesn't have sufficient funds for the specified amount, an
	 * insufficient funds fee (penalty) is charged on the account.
	 * 
	 * @param amount
	 ...
	 * @param toAccount
	 *            The account in which the funds will be deposited
	 * @param amount
	...
	/**
	 * @param accountDescription
	 *            The replacement description of this account
	 */
	...
	/**
	 * @param transactionId
	 *            The id of the transaction to search for
