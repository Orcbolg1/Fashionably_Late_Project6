...
public class Bank {
	...
	/**
	 * @param insufficientFundsPenalty
	 *            the insufficientFundsPenalty to set
	 */
	 ...
	 * 
	 * @return A list of all accounts of all customers of this bank, sorted by
	 *         ID.
	 * 
	 */
	 ...
	 * 
	 * @param lastName
	 *            Customer's last (sur- or family) name
	 * @param firstName
	...
	/**
	 * Deletes a customer from the bank. (In reality, just marks the customer as
	 * non-current.)
	 * 
	 * @param customerId
	 ...
	 * @return a List of Customers with that first and last name, or null if no
	 ...
	 * 
	 * @param customerId
	 *            The Customer ID who's account list is desired.
