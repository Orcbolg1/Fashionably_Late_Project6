...
public class Customer implements Comparable<Customer> {
	 ...
	 * assume bank names are unique.
	 * 
	 * @param bank
	 *            The bank owning this account
	 * @param lastName
	 ...
	 * 
	 * @return an immutable SortedSet of accounts (check for immutability of
	 *         accounts; use a List?)
	 */
	...
	/**
	 * Returns the total fees (including penalties) paid by this customer for
	 * year-to-date
	 * 
	 ...
	 *            Initial balance
	 * @param desc
	 *            A description for the account, chosen by the customer
	...
	/**
	 * Deletes a given account (in the real world, just marks it as defunct or
	 * something)
	 * 
	 * @param accountId
